...
We can further simplify the first few terms of this equation as well. Specifically, $$\frac {n!}{(n - k)!}$$ collapses to $$n \cdot (n - 1) \cdot (n - 2) \dots (n - k + 1)$$. These terms can be coupled with $$n^k$$ in the denominator as follows:

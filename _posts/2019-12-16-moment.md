...
$$\begin{align*} M_X(t) = \mathbf{E}(1 + tX + \frac{t^2 X^2}{2!} + \frac{t^3 X^3}{3!} + \cdots ) &= \mathbf{E}(e^{tX}) &= 1 + t\mathbf{E}(X) + \frac{t^2 \mathbf{E}(X^2)}{2!} + \frac{t^3 \mathbf{E}(X^3)}{3!} + \cdots \end{align*} \tag{4}$$ 
...
$$\frac{d}{dt}M_X(t) = \frac{d}{dt}\left[1 + t\mathbf{E}(X) + \frac{t^2 \mathbf{E}(X^2)}{2!} + \frac{t^3 \mathbf{E}(X^3)}{3!} + \cdots \right] = \mathbf{E}(X) + t\mathbf{E}(X^2) + \frac{t^2 \mathbf{E}(X^3)}{2!} + \cdots \tag{5}$$
...
$$\begin{align*} \mathbf{E}(X) &= \lambda e^{- \lambda} \sum_{k \geq 1} \frac{\lambda^{x - 1}}{(x - 1)!} &= \lambda e^{- \lambda} e^\lambda &= \lambda$$ \end{align*}$$

where the third equality stands given the variant of the Taylor polynomial for the exponential function we looked at earlier:
...
$$\begin{align*} M_X(t) &= \lambda \lvert \frac{1}{t - \lambda} e^{(t - \lambda)x} \rvert_0^\infty &= \lambda(0 - \frac{1}{t -\lambda}) = \frac{\lambda}{\lambda - t} \end{align*} \tag{12}$$
